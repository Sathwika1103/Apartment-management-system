...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from tbladmin where  UserName='$adminuser' && Password='$password' && UserType='$usertype' ");
    ...
    echo $msg;
                        ...
                        <div class="login-form">
                            <form action="" method="post" name="login">
                                ...
                                <!--<div class="login-checkbox" style="padding-bottom: 20px;padding-top: 20px;">
