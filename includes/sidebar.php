...
<a href="manage-passes.php">Manage</a>
                      ...
                      <!-- <li>
                        ...
                        <li>
                            <a href="complaints.php" style="color: blue">
                                <i class="fas fa-exclamation-triangle"></i>Complaints</a>
                         </li>

                         <li>
                            <a href="viewcomplaints.php" style="color: blue">
                                <i class="fas fa-exclamation-triangle"></i>Manage Complaints</a>
                         </li>

                         <li>
                            <a href="vehicle.php" style="color: blue">
                                <i class="fas fa-car"></i>New Parking</a>
                         </li>
                         <li>
                            <a href="manageparking.php" style="color: blue">
                                <i class="fas fa-car"></i>Manage Parking</a>
                         </li>
